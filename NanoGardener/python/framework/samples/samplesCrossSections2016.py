...
samples['EWK_LNuJJ']                .extend( ['xsec=20.44',	'kfact=1.000',	'ref=I'] )
samples['EWK_LNuJJ_herwig']                .extend( ['xsec=20.43',	'kfact=1.000',	'ref=I'] )
samples['EWK_LLJJ']                .extend( ['xsec=1.629',	'kfact=1.000',	'ref=I'] )
samples['EWK_LLJJ_herwig'] .extend( ['xsec=0.9838',     'kfact=1.000',   'ref=I' ])
...
# central mini and private nano VBS aQGC semilep 2016 with dipole recoil and new operators, produced by Irene at LPC
...
# central mini and private nano VBS aQGC semilep 2016 with dipole recoil and new operators, produced by Matteo at KIT
